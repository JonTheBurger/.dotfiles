...
ly is a bare-bones, text-based display manager used for logging in. I prefer a
fast login over a pretty login. `greetd-tuigreet greetd` is something I'm also
interested in...

> See also: tuigreet, light-dm, plasma-login-manager
