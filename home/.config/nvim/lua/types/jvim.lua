...
---@field ai_model string From https://models.dev/, set to empty string to disable. Pricing at https://docs.github.com/en/copilot/reference/copilot-billing/models-and-pricing
