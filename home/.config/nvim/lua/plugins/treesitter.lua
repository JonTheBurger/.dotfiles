...
return {
  ...
  },
  {
    ...
    keys = {
      ...
      { "a<F1>", function() require("nvim-treesitter-textobjects.select").select_textobject("@comment.outer", "textobjects") end,  mode = { "o", "x" }, desc = "Around Comment" },
      { "i<F1>", function() require("nvim-treesitter-textobjects.select").select_textobject("@comment.inner", "textobjects") end,  mode = { "o", "x" }, desc = "Inside Comment" },
      ...
      { "a~", function() require("nvim-treesitter-textobjects.select").select_textobject("@codeblock.outer", "textobjects") end,   mode = { "o", "x" }, desc = "Around CodeBlock" },
      { "i~", function() require("nvim-treesitter-textobjects.select").select_textobject("@codeblock.inner", "textobjects") end,   mode = { "o", "x" }, desc = "Inside CodeBlock" },
      -- Move
      ...
      { "]F", function() require("nvim-treesitter-textobjects.move").goto_next_end("@function.outer", "textobjects") end,          mode = { "n", "x", "o" }, desc = "End of Function" },
      ...
      { "]C", function() require("nvim-treesitter-textobjects.move").goto_next_start("@class.outer", "textobjects") end,           mode = { "n", "x", "o" }, desc = "Next Class" },
      { "[<F1>", function() require("nvim-treesitter-textobjects.move").goto_previous_start("@comment.outer", "textobjects") end,  mode = { "n", "x", "o" }, desc = "Previous Comment" },
      { "]<F1>", function() require("nvim-treesitter-textobjects.move").goto_next_start("@comment.outer", "textobjects") end,      mode = { "n", "x", "o" }, desc = "Next Comment" },
      { "[p", function() require("nvim-treesitter-textobjects.move").goto_previous_start("@local.scope", "locals") end,            mode = { "n", "x", "o" }, desc = "Previous Local Scope" },
      { "]p", function() require("nvim-treesitter-textobjects.move").goto_next_start("@local.scope", "locals") end,                mode = { "n", "x", "o" }, desc = "Next Local Scope" },
      { "[z", function() require("nvim-treesitter-textobjects.move").goto_previous_start("@fold", "folds") end,                    mode = { "n", "x", "o" }, desc = "Previous Fold" },
      ...
      -- Swap
      { "gw", function() require("nvim-treesitter-textobjects.swap").swap_next("@parameter.inner") end,     mode = { "n" }, desc = "Swap Next Argument" },
      { "gW", function() require("nvim-treesitter-textobjects.swap").swap_previous("@parameter.inner") end, mode = { "n" }, desc = "Swap Previous Argument" },
      -- Repeat Move
  ...
  },
  {
    ...
    keys = {
      -- stylua: ignore start
      { "i$", function() require("various-textobjs").lineCharacterwise("inner") end,    mode = { "o", "x" }, desc = "Inside Line Chars" },
      { "a$", function() require("various-textobjs").lineCharacterwise("outer") end,    mode = { "o", "x" }, desc = "Around Line Chars" },
      { "au", function() require("various-textobjs").subword("outer") end,              mode = { "o", "x" }, desc = "Inside sUbword" },
      { "iu", function() require("various-textobjs").subword("inner") end,              mode = { "o", "x" }, desc = "Around sUbword" },
      ...
      { "i>", function() require("various-textobjs").indentation("inner", "inner") end, mode = { "o", "x" }, desc = "Inside Indent" },
      { "a>", function() require("various-textobjs").indentation("outer", "outer") end, mode = { "o", "x" }, desc = "Around Indent" },
      -- stylua: ignore end
    },
  },
}
